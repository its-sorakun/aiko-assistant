...
* - The Console Application can be built using Microsoft Visual Studio 2022 or later with the solution file available in the AMDRyzenMasterMonitoringSampleApp folder
...
* - AMD Family 19h Processor
* - AMD Family 1Ah Processor
...
* @param L1DataCache [out]  Reference of variable of struct CACHE_INFO which will hold value of L1DataCache
* @return
*	- 0  - if successful.
*	- -1 - if failure.
*/
...
* @param L1InstCache [out]  Reference of variable of struct CACHE_INFO which will hold value of L1Instruction Cache.
* @return
*	- 0  - if successful.
*	- -1 - if failure.
*/
...
* @param L2Cache [out]  Reference of variable of struct CACHE_INFO which will hold value of L2 Cache.
* @return
*	- 0  - if successful.
*	- -1 - if failure.
*/
...
* @param L3Cache [out]  Reference of variable of struct CACHE_INFO which will hold value of L3 Cache.
* @return
*	- 0  - if successful.
*	- -1 - if failure.
*/
...
* @param uVal [out] Reference of unsigned int which will hold the physical core count of the processor
* @return
*	- 0  - if successful.
*	- -1 - if failure.
*/
...
* @param uVal [out] Reference of unsigned integer variable which will hold number of parked cores.
* @return
*	- 0  - if successful.
*	- -1 - if failure.
*/
...
* @param	stInfo [out] Reference of CPUParameters structure variable having power related information, Current OC Mode, Effective Freq etc.
* @return Status
*	-  -1 --> Failure
*	-   0 --> Success
...
/**
* Get Chipset Name string
* @param  sChipsetName [out] If the function succeeds, it will have string containing Chipset ID .
* @return Status
*	-  -1 --> Failure
*	-   0 --> Success
*	-   4 --> Unsupported Function
*/
	virtual int GetChipsetName(wchar_t* sChipsetName) = 0;

/**
* Gets Family of the processor
* @param uFamily [out] Reference of unsigned long which will hold the value of Family
* @return
*	- 0  - if successful.
*	- -1 - if failure.
*/
	virtual int GetFamily(unsigned long& uFamily) = 0;

/**
* Gets stepping number of the processor as obtained from CPUID instruction CPUID_Fn00000001_EAX.
* @param uStepping [out] Reference of unsigned long which will hold value of stepping number
* @return
*	- 0  - if successful.
*	- -1 - if failure.
*/
	virtual int GetStepping(unsigned long& uStepping) = 0;

/**
* Gets model number of the processor as obtained from CPUID instruction CPUID_Fn80000001_EBX.
* @param uModel [out] Reference of unsigned long which will hold value of model number.
* @return
*	- 0  - if successful.
*	- -1 - if failure.
*/
	virtual int GetModel(unsigned long& uModel) = 0;
};
#endif